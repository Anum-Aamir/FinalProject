...
public class FaceFilterActivity extends AppCompatActivity {//implements FaceFilterActivity.MyRecyclerViewAdapter.ItemClickListener
    ...
    private void initGlassesList() {
        ...
        filterImagesList.add(R.drawable.glassesh);
        filterImagesList.add(R.drawable.glassesb);
        filterImagesList.add(R.drawable.box);
        filterImagesList.add(R.drawable.glassesb1);
    ...
    private void initMasksList() {
        ...
        filterImagesList.add(R.drawable.mask1);
    ...
    private void initcrownList() {
        filterImagesList.clear();
        filterImagesList.add(R.drawable.crown1);
        filterImagesList.add(R.drawable.crown2);
    ...
    private ImageButton emptyImageButton, hatImageButton,
            maskImageButton, glassesImageButton, animalImageButton, crownImageButton;
    ...
    private ImageView hatImageView, hat2ImageView, maskImageView, mask2ImageView,
            ...
            cat2ImageView, dogImageView, snapImageView,crownImageView;
...
//                    findViewById(R.id.scrollView).setVisibility(GONE);
        ...
        ImageButton mask = (ImageButton) findViewById(R.id.mask1);
...
//        View screenView = topLayout.getRootView();
    ...
    private void initViews() {
        ...
        crownImageButton = findViewById(R.id.crown_image_button);
        ...
        crownImageButton.setOnClickListener(crownImageButtonClickListener());
    ...
    private View.OnClickListener crownImageButtonClickListener() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                currentImageButton.setBackgroundResource(R.drawable.round_background);
                currentImageButton = crownImageButton;
...
//                File imageFile;
                ...
                marginLayoutParams.setMargins(90,90,90,90);
...
//                Bitmap finalBitmap = getScreenShot();
        ...
        dialog.findViewById(R.id.shareBtn_imagetaken).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MarginLayoutParams marginLayoutParams=(MarginLayoutParams) imageView2.getLayoutParams();
                if(mCameraSource.getCameraFacing()==CameraSource.CAMERA_FACING_BACK){
                marginLayoutParams.setMargins(110,110,110,90);
                }
                else {
